        ...
        for (int i = 0; i < FD_SETSIZE; i++) {
            if (FD_ISSET(i, &tmp_set)) {
                ...
                // If it was not meant for us, then forward the packet
                    ...
                    newArpHeader->ea_hdr.ar_hrd = 1;
                    newArpHeader->ea_hdr.ar_pro = 0x800;
                    newArpHeader->ea_hdr.ar_hln = 6;
                    newArpHeader->ea_hdr.ar_pln = 4;
                    newArpHeader->ea_hdr.ar_op = ARPOP_REQUEST;
                    ...
                    // memcpy(newArpHeader->tpa, ) how to find next IP in chain?
